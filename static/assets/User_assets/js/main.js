  ...
  t.on("load", function (a, o) {
    ...
    l.delay("500").fadeOut(2e3),
      ...
      e(".cat-menu-toggle").on("click", function () {
        e(".category-off-canvas-menu, .body-overlay").addClass("active"),
          e("body").css({ overflow: "hidden" });
      }),
      e(".cat-menu-close, .body-overlay").on("click", function () {
        e(".category-off-canvas-menu, .body-overlay").removeClass("active"),
          e("body").css({ overflow: "inherit" });
      }),
    ...
    t.on("scroll", function () {
          ...
          t.addClass("active"),
            ...
            t.is(".active-resource")
              ...
              : t.not(".active-resource") &&
                e(".lecture-viewer-text-wrap").removeClass("active");
        }
      ),
      ...
      s.on("click", ".ask-new-question-btn", function () {
        e(".new-question-wrap, .question-overview-result-wrap").addClass(
          "active"
        );
      }),
      s.on(
        ...
        function () {
          e(".replay-question-wrap, .question-overview-result-wrap").addClass(
            "active"
          );
        }
      ),
    ...
    for (
      var O = document.querySelectorAll(".payment-tab-toggle > input"), A = 0;
      A < O.length;
      A++
    )
    ...
    e(N).on("click", function () {
      ...
      e(j).length &&
        e(j).intlTelInput({ separateDialCode: !0, utilsScript: "js/utils.js" }),
      e(z).length &&
        e(z).MultiFile({ accept: "pdf, doc, docx, rtf, html, odf, zip" }),
      e(M).length && e(M).Lazy();
    var B,
        ...
        e &&
          e.addEventListener("click", function () {
            if (K.matches) {
              ...
              var e = document.body.classList.contains("light-theme")
                ? "light"
                : "dark";
            } else {
              document.body.classList.toggle("dark-theme");
